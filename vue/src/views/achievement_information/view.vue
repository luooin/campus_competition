	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
				...
				<el-form-item label="项目名称" prop="entry_name">
							  ...
							  v-if="user_group === '管理员' || (form['achievement_information_id'] && $check_field('set','entry_name')) || (!form['achievement_information_id'] && $check_field('add','entry_name'))" :disabled="disabledObj['entry_name_isDisabled']"></el-input>
				...
				<el-form-item label="项目类别" prop="project_category">
							  ...
							  v-if="user_group === '管理员' || (form['achievement_information_id'] && $check_field('set','project_category')) || (!form['achievement_information_id'] && $check_field('add','project_category'))" :disabled="disabledObj['project_category_isDisabled']"></el-input>
				...
				<el-form-item label="项目时间" prop="project_time">
							  ...
							  v-if="user_group === '管理员' || (form['achievement_information_id'] && $check_field('set','project_time')) || (!form['achievement_information_id'] && $check_field('add','project_time'))" :disabled="disabledObj['project_time_isDisabled']"></el-input>
				...
				<el-form-item label="项目选手" prop="event_players">
													<el-select v-if="user_group === '管理员' || (form['achievement_information_id'] && $check_field('set','event_players')) || (!form['achievement_information_id'] && $check_field('add','event_players'))" id="event_players" v-model="form['event_players']" :disabled="disabledObj['event_players_isDisabled']">
				...
				<el-form-item label="用户学号" prop="user_student_id">
							  ...
							  v-if="user_group === '管理员' || (form['achievement_information_id'] && $check_field('set','user_student_id')) || (!form['achievement_information_id'] && $check_field('add','user_student_id'))" :disabled="disabledObj['user_student_id_isDisabled']"></el-input>
				...
				<el-form-item label="用户姓名" prop="user_name">
							  ...
							  v-if="user_group === '管理员' || (form['achievement_information_id'] && $check_field('set','user_name')) || (!form['achievement_information_id'] && $check_field('add','user_name'))" :disabled="disabledObj['user_name_isDisabled']"></el-input>
				...
				<el-form-item label="成绩分数" prop="score">
						...
						v-if="user_group === '管理员' || (form['achievement_information_id'] && $check_field('set','score')) || (!form['achievement_information_id'] && $check_field('add','score'))" :disabled="disabledObj['score_isDisabled']"></el-input-number>
