	...
	<el-menu class="side el-menu-vertical-demo" default-active="/" @open="handleOpen" @close="handleClose"
		...
		<el-submenu index="user"
			...
			<el-menu-item index="/user/table" v-show="user_group == '管理员'"><span>管理员</span></el-menu-item>
						<el-menu-item index="/operator/table" v-show="user_group == '管理员' || $check_action('/operator/table')"><span>操作人员</span></el-menu-item>
							<el-menu-item index="/participating_users/table" v-show="user_group == '管理员' || $check_action('/participating_users/table')"><span>参赛用户</span></el-menu-item>
