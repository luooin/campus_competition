...
public class BaseController<E, S extends BaseService<E>> {
    ...
    public Map<String, Object> upload(@RequestParam("file") MultipartFile file) {
        ...
        try {
            //判断有没路径，没有则创建
//            String filePath = System.getProperty("user.dir") + "\\server\\target\\classes\\static\\upload\\";
            File targetDir = new File("src/main/resources/static/upload/");
...
//            String filePath = path.replace('/', '\\').substring(1, path.length());
            ...
            File dest = new File(targetDir.getAbsolutePath()+"/" + fileName);
